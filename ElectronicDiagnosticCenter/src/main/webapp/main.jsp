...
<img alt="" src="logo.png" class="logo">
  ...
  <ul class="navbar-nav mr-auto">
    ...
    <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu" aria-labelledby="serviceDropdown">
        ...
        <a class="dropdown-item" href="underdevelopment.jsp">Service Status</a>
        <a class="dropdown-item" href="/ElectronicDiagnosticCenter/ServiceHistory">Service History</a>
      </div>
    </li>
  </ul>
  ...
  <ul class="navbar-nav ml-auto">
      ...
      <div class="dropdown-menu" aria-labelledby="userDropdown">
        ...
        <a class="dropdown-item" href="underdevelopment.jsp">Sign Out</a>
      </div>
    </li>
    <li class="nav-item">
