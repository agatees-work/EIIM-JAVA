    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-sm-8 col-xs-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="ServiceRequestValidator" method="post">
                        ...
                        <div class="form-group">
                            <label class="label">Device:</label>
						        <select  class="form-control" id="dropdownSelection" name="deviceSelection" required>
                        ...
                        <div class="form-group">
                            <label class="label">Service types:</label>
						        <select  class="form-control" id="dropdownSelection" name="serviceSelection" required>
					                <option value="" disabled selected></option>
